"use strict";(self.webpackChunkpantsbuild_org=self.webpackChunkpantsbuild_org||[]).push([["761727"],{889023(e,a,c){c.r(a),c.d(a,{assets:()=>_,contentTitle:()=>n,default:()=>m,frontMatter:()=>o,metadata:()=>d,toc:()=>l});var d=c(175520),f=c(886070),b=c(848193),r=c(554707),s=c(375002);let o={title:"download-terraform",description:"Terraform (https://terraform.io)\n"},n,_={},l=[{value:"Basic options",id:"basic-options",level:2},{value:"<code>args</code>",id:"args",level:3},{value:"Advanced options",id:"advanced-options",level:2},{value:"<code>extra_env_vars</code>",id:"extra_env_vars",level:3},{value:"<code>known_versions</code>",id:"known_versions",level:3},{value:"<code>platforms</code>",id:"platforms",level:3},{value:"<code>tailor</code>",id:"tailor",level:3},{value:"<code>url_platform_mapping</code>",id:"url_platform_mapping",level:3},{value:"<code>url_template</code>",id:"url_template",level:3},{value:"<code>use_unsupported_version</code>",id:"use_unsupported_version",level:3},{value:"<code>version</code>",id:"version",level:3},{value:"Deprecated options",id:"deprecated-options",level:2},{value:"Related subsystems",id:"related-subsystems",level:2}];function i(e){let a={a:"a",code:"code",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",ul:"ul",...(0,b.R)(),...e.components};return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(a.hr,{}),"\n",(0,f.jsxs)(a.p,{children:["Terraform (",(0,f.jsx)(a.a,{href:"https://terraform.io",children:"https://terraform.io"}),")"]}),"\n",(0,f.jsxs)(a.p,{children:["Backend: ",(0,f.jsx)("span",{className:"color--primary",children:(0,f.jsx)(a.code,{children:"pants.backend.experimental.terraform"})})]}),"\n",(0,f.jsxs)(a.p,{children:["Config section: ",(0,f.jsx)("span",{className:"color--primary",children:(0,f.jsx)(a.code,{children:"[download-terraform]"})})]}),"\n",(0,f.jsxs)("span",{className:s.A.options,children:[(0,f.jsx)(a.h2,{id:"basic-options",children:"Basic options"}),(0,f.jsx)(a.h3,{id:"args",children:(0,f.jsx)(a.code,{children:"args"})}),(0,f.jsxs)(r.A,{cli_repr:'--download-terraform-args="[<shell_str>, <shell_str>, ...]", ... -- [<shell_str> [<shell_str> [...]]]',env_repr:"PANTS_DOWNLOAD_TERRAFORM_ARGS",toml_repr:`[download-terraform]
args = [
  <shell_str>,
  <shell_str>,
  ...,
]`,default_repr:"[]",children:[(0,f.jsxs)(a.p,{children:["Arguments to pass directly to terraform, e.g. ",(0,f.jsx)(a.code,{children:"--download-terraform-args='-auto-approve'"}),"."]}),(0,f.jsx)(a.p,{children:"Additional arguments to pass to the Terraform command line."})]}),(0,f.jsx)(a.h2,{id:"advanced-options",children:"Advanced options"}),(0,f.jsx)(a.h3,{id:"extra_env_vars",children:(0,f.jsx)(a.code,{children:"extra_env_vars"})}),(0,f.jsxs)(r.A,{cli_repr:"--download-terraform-extra-env-vars=\"['<str>', '<str>', ...]\"",env_repr:"PANTS_DOWNLOAD_TERRAFORM_EXTRA_ENV_VARS",toml_repr:`[download-terraform]
extra_env_vars = [
  '<str>',
  '<str>',
  ...,
]`,default_repr:"[]",children:[(0,f.jsx)(a.p,{children:"Additional environment variables that would be made available to all Terraform processes."}),(0,f.jsxs)(a.p,{children:["Entries are strings in the form ",(0,f.jsx)(a.code,{children:"ENV_VAR=value"})," to use explicitly; or just ",(0,f.jsx)(a.code,{children:"ENV_VAR"})," to copy the value of a variable in Pants's own environment. ",(0,f.jsx)(a.code,{children:"fnmatch"})," globs like ",(0,f.jsx)(a.code,{children:"ENV_VAR_PREFIXED_*"})," can be used to copy multiple environment variables."]})]}),(0,f.jsx)(a.h3,{id:"known_versions",children:(0,f.jsx)(a.code,{children:"known_versions"})}),(0,f.jsxs)(r.A,{cli_repr:"--download-terraform-known-versions=\"['<str>', '<str>', ...]\"",env_repr:"PANTS_DOWNLOAD_TERRAFORM_KNOWN_VERSIONS",toml_repr:`[download-terraform]
known_versions = [
  '<str>',
  '<str>',
  ...,
...
]`,children:[(0,f.jsx)(a.p,{children:"Known versions to verify downloads against."}),(0,f.jsxs)(a.p,{children:["Each element is a pipe-separated string of ",(0,f.jsx)(a.code,{children:"version|platform|sha256|length"})," or\n",(0,f.jsx)(a.code,{children:"version|platform|sha256|length|url_override"}),", where:"]}),(0,f.jsxs)(a.ul,{children:["\n",(0,f.jsxs)(a.li,{children:[(0,f.jsx)(a.code,{children:"version"})," is the version string"]}),"\n",(0,f.jsxs)(a.li,{children:[(0,f.jsx)(a.code,{children:"platform"})," is one of ",(0,f.jsx)(a.code,{children:"[linux_arm64,linux_x86_64,macos_arm64,macos_x86_64]"})]}),"\n",(0,f.jsxs)(a.li,{children:[(0,f.jsx)(a.code,{children:"sha256"})," is the 64-character hex representation of the expected sha256\ndigest of the download file, as emitted by ",(0,f.jsx)(a.code,{children:"shasum -a 256"})]}),"\n",(0,f.jsxs)(a.li,{children:[(0,f.jsx)(a.code,{children:"length"})," is the expected length of the download file in bytes, as emitted by\n",(0,f.jsx)(a.code,{children:"wc -c"})]}),"\n",(0,f.jsxs)(a.li,{children:["(Optional) ",(0,f.jsx)(a.code,{children:"url_override"})," is a specific url to use instead of the normally\ngenerated url for this version"]}),"\n"]}),(0,f.jsxs)(a.p,{children:["E.g., ",(0,f.jsx)(a.code,{children:"3.1.2|macos_x86_64|6d0f18cd84b918c7b3edd0203e75569e0c7caecb1367bbbe409b44e28514f5be|42813"}),".\nand ",(0,f.jsx)(a.code,{children:"3.1.2|macos_arm64 |aca5c1da0192e2fd46b7b55ab290a92c5f07309e7b0ebf4e45ba95731ae98291|50926|https://example.mac.org/bin/v3.1.2/mac-aarch64-v3.1.2.tgz"}),"."]}),(0,f.jsx)(a.p,{children:"Values are space-stripped, so pipes can be indented for readability if necessary."})]}),(0,f.jsx)(a.h3,{id:"platforms",children:(0,f.jsx)(a.code,{children:"platforms"})}),(0,f.jsx)(r.A,{cli_repr:"--download-terraform-platforms=\"['<str>', '<str>', ...]\"",env_repr:"PANTS_DOWNLOAD_TERRAFORM_PLATFORMS",toml_repr:`[download-terraform]
platforms = [
  '<str>',
  '<str>',
  ...,
]`,default_repr:"[]",children:(0,f.jsxs)(a.p,{children:["Platforms to generate lockfiles for. See the ",(0,f.jsx)(a.a,{href:"https://developer.hashicorp.com/terraform/cli/commands/providers/lock#platform-os_arch",children:"documentation for the providers lock command"}),". For example, ",(0,f.jsx)(a.code,{children:'["windows_amd64", "darwin_amd64", "linux_amd64"]'})]})}),(0,f.jsx)(a.h3,{id:"tailor",children:(0,f.jsx)(a.code,{children:"tailor"})}),(0,f.jsx)(r.A,{cli_repr:"--[no-]download-terraform-tailor",env_repr:"PANTS_DOWNLOAD_TERRAFORM_TAILOR",toml_repr:`[download-terraform]
tailor = <bool>`,default_repr:"True",children:(0,f.jsxs)(a.p,{children:["If true, add ",(0,f.jsx)(a.code,{children:"terraform_module"})," targets with the ",(0,f.jsx)(a.code,{children:"tailor"})," goal."]})}),(0,f.jsx)(a.h3,{id:"url_platform_mapping",children:(0,f.jsx)(a.code,{children:"url_platform_mapping"})}),(0,f.jsxs)(r.A,{cli_repr:"--download-terraform-url-platform-mapping=\"{'key1': val1, 'key2': val2, ...}\"",env_repr:"PANTS_DOWNLOAD_TERRAFORM_URL_PLATFORM_MAPPING",toml_repr:`[download-terraform.url_platform_mapping]
key1 = val1
key2 = val2
...`,default_repr:`{
...
}`,children:[(0,f.jsx)(a.p,{children:"A dictionary mapping platforms to strings to be used when generating the URL to download the tool."}),(0,f.jsxs)(a.p,{children:["In ",(0,f.jsx)(a.code,{children:"--url-template"}),", anytime the ",(0,f.jsx)(a.code,{children:"{platform}"})," string is used, Pants will determine the current platform, and substitute ",(0,f.jsx)(a.code,{children:"{platform}"})," with the respective value from your dictionary."]}),(0,f.jsxs)(a.p,{children:["For example, if you define ",(0,f.jsx)(a.code,{children:'{"macos_x86_64": "apple-darwin", "linux_x86_64": "unknown-linux"}'}),", and run Pants on Linux with an intel architecture, then ",(0,f.jsx)(a.code,{children:"{platform}"})," will be substituted in the ",(0,f.jsx)(a.code,{children:"--url-template"})," option with ",(0,f.jsx)(a.code,{children:"unknown-linux"}),"."]})]}),(0,f.jsx)(a.h3,{id:"url_template",children:(0,f.jsx)(a.code,{children:"url_template"})}),(0,f.jsxs)(r.A,{cli_repr:"--download-terraform-url-template=<str>",env_repr:"PANTS_DOWNLOAD_TERRAFORM_URL_TEMPLATE",toml_repr:`[download-terraform]
url_template = <str>`,default_repr:"https://releases.hashicorp.com/terraform/{version}/terraform_{version}_{platform}.zip",children:[(0,f.jsxs)(a.p,{children:["URL to download the tool, either as a single binary file or a compressed file (e.g. zip file). You can change this to point to your own hosted file, e.g. to work with proxies or for access via the filesystem through a ",(0,f.jsx)(a.code,{children:"file:$abspath"})," URL (e.g. ",(0,f.jsx)(a.code,{children:"file:/this/is/absolute"}),", possibly by ",(0,f.jsx)(a.a,{href:"https://www.pantsbuild.org/2.29/docs/using-pants/key-concepts/options#config-file-entries",children:"templating the buildroot in a config file"}),")."]}),(0,f.jsxs)(a.p,{children:["Use ",(0,f.jsx)(a.code,{children:"{version}"})," to have the value from ",(0,f.jsx)(a.code,{children:"--version"})," substituted, and ",(0,f.jsx)(a.code,{children:"{platform}"})," to have a value from ",(0,f.jsx)(a.code,{children:"--url-platform-mapping"})," substituted in, depending on the current platform. For example, ",(0,f.jsx)(a.a,{href:"https://github.com/.../protoc-&#123;version&#125;-&#123;platform&#125;.zip",children:"https://github.com/.../protoc-&#123;version&#125;-&#123;platform&#125;.zip"}),"."]})]}),(0,f.jsx)(a.h3,{id:"use_unsupported_version",children:(0,f.jsx)(a.code,{children:"use_unsupported_version"})}),(0,f.jsxs)(r.A,{cli_repr:"--download-terraform-use-unsupported-version=<UnsupportedVersionUsage>",env_repr:"PANTS_DOWNLOAD_TERRAFORM_USE_UNSUPPORTED_VERSION",toml_repr:`[download-terraform]
use_unsupported_version = <UnsupportedVersionUsage>`,one_of:"error, warning",default_repr:"error",children:[(0,f.jsx)(a.p,{children:"What action to take in case the requested version of terraform is not supported."}),(0,f.jsx)(a.p,{children:"Supported terraform versions: unspecified"})]}),(0,f.jsx)(a.h3,{id:"version",children:(0,f.jsx)(a.code,{children:"version"})}),(0,f.jsx)(r.A,{cli_repr:"--download-terraform-version=<str>",env_repr:"PANTS_DOWNLOAD_TERRAFORM_VERSION",toml_repr:`[download-terraform]
version = <str>`,default_repr:"1.9.0",children:(0,f.jsx)(a.p,{children:"Use this version of terraform."})}),(0,f.jsx)(a.h2,{id:"deprecated-options",children:"Deprecated options"}),(0,f.jsx)(a.p,{children:"None"}),(0,f.jsx)(a.h2,{id:"related-subsystems",children:"Related subsystems"}),(0,f.jsx)(a.p,{children:"None"})]})]})}function m(e={}){let{wrapper:a}={...(0,b.R)(),...e.components};return a?(0,f.jsx)(a,{...e,children:(0,f.jsx)(i,{...e})}):i(e)}},375002(e,a,c){c.d(a,{A:()=>d});let d={options:"options_nrbo"}},554707(e,a,c){c.d(a,{A:()=>r});var d=c(886070),f=c(384122),b=c(580830);function r({children:e,cli_repr:a,env_repr:c,toml_repr:r,one_of:s,default_repr:o,target_field_name:n,removal_version:_,removal_hint:l}){return(0,d.jsxs)("div",{className:"margin-bottom--lg",children:[(0,d.jsx)("code",{style:{color:"var(--pants-reference-option-repr)"},children:a}),(0,d.jsx)("br",{}),(0,d.jsx)("code",{style:{color:"var(--pants-reference-option-repr)"},children:c}),(0,d.jsx)("br",{}),(0,d.jsx)(f.A,{language:"toml",title:"pants.toml",children:r}),(0,d.jsxs)("div",{style:{paddingLeft:"2em"},children:[(0,d.jsxs)("span",{children:[s&&(0,d.jsxs)("span",{children:["one of:"," ",(0,d.jsx)("code",{style:{color:"var(--ifm-color-success)"},children:s}),(0,d.jsx)("br",{})]}),"default:"," ",(0,d.jsx)("span",{style:{color:"var(--ifm-color-success)"},children:(o||"").includes("\n")?(0,d.jsx)("pre",{className:"padding--sm",children:o}):(0,d.jsx)("code",{children:o})})]}),(0,d.jsx)("br",{}),_&&(0,d.jsxs)("span",{style:{color:"var(--ifm-color-danger-darkest)"},children:["Deprecated, will be removed in version: ",_,".",(0,d.jsx)("br",{}),l,(0,d.jsx)("br",{})]}),e,n&&(0,d.jsxs)("span",{children:["Can be overriden by field",(0,d.jsx)("code",{children:n})," on"," ",(0,d.jsx)(b.A,{to:"../targets/local_environment",children:(0,d.jsx)("code",{children:"local_environment"})}),","," ",(0,d.jsx)(b.A,{to:"../targets/docker_environment",children:(0,d.jsx)("code",{children:"docker_environment"})}),", or"," ",(0,d.jsx)(b.A,{to:"../targets/remote_environment",children:(0,d.jsx)("code",{children:"remote_environment"})}),"targets."]})]})]})}},175520(e){e.exports=JSON.parse('{"id":"reference/subsystems/download-terraform","title":"download-terraform","description":"Terraform (https://terraform.io)\\n","source":"@site/versioned_docs/version-2.29/reference/subsystems/download-terraform.mdx","sourceDirName":"reference/subsystems","slug":"/reference/subsystems/download-terraform","permalink":"/2.29/reference/subsystems/download-terraform","draft":false,"unlisted":false,"tags":[],"version":"2.29","frontMatter":{"title":"download-terraform","description":"Terraform (https://terraform.io)\\n"},"sidebar":"referenceSidebar","previous":{"title":"dockerfile-parser","permalink":"/2.29/reference/subsystems/dockerfile-parser"},"next":{"title":"environments-preview","permalink":"/2.29/reference/subsystems/environments-preview"}}')}}]);